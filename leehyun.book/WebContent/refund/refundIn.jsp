...
<script>
	...
	function ck(){
		if(parseInt($('input.cnt0').val()) < 1 || parseInt($('input.cnt0').val()) > parseInt($('input.max0').val()) || 
				parseInt($('input.cnt1').val()) < 1 || parseInt($('input.cnt1').val()) > parseInt($('input.max1').val()) || 
				parseInt($('input.cnt2').val()) < 1 || parseInt($('input.cnt2').val()) > parseInt($('input.max2').val()) || 
				parseInt($('input.cnt3').val()) < 1 || parseInt($('input.cnt3').val()) > parseInt($('input.max3').val()) || 
				parseInt($('input.cnt4').val()) < 1 || parseInt($('input.cnt4').val()) > parseInt($('input.max4').val()) || 
				parseInt($('input.cnt5').val()) < 1 || parseInt($('input.cnt5').val()) > parseInt($('input.max5').val()) || 
				parseInt($('input.cnt6').val()) < 1 || parseInt($('input.cnt6').val()) > parseInt($('input.max6').val()) || 
				parseInt($('input.cnt7').val()) < 1 || parseInt($('input.cnt7').val()) > parseInt($('input.max7').val()) || 
				parseInt($('input.cnt8').val()) < 1 || parseInt($('input.cnt8').val()) > parseInt($('input.max8').val()) || 
				parseInt($('input.cnt9').val()) < 1 || parseInt($('input.cnt9').val()) > parseInt($('input.max9').val())){
			alert_cnterr();
		}else{
			alert_refund();
		}
...
%>
					<tr>
						...
						<td><%=df.format(book.getbookPrice()) %><input type="number" class="max<%=i%>" value="<%= orderbook.getOrderCnt() - refundBooksService.getCnt(book.getisbn(), orderNum)%>" style="display: none;"></td>
					</tr>
<%
					i++;
					}
